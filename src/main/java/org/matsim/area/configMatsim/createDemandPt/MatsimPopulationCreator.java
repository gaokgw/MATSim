...
import org.matsim.area.MatsimExecuter;
...
*/
        ...
        Accessibility acc = new Accessibility(MatsimExecuter.rb.getString("base.skim.file"), "mat1", MatsimExecuter.rb);
...
//                sumOrigRates += origRate[origLoc.getId() - 1];
            ...
            float carShare = Float.parseFloat(MatsimExecuter.rb.getString("car.modal.share"));
...
//    		Activity activity2 = matsimPopulationFactory.createActivityFromCoord("work", ct.transform(workCoordinates));
    ...
    public void createSyntheticPtPopulation(ArrayList<Location> servedZonesList, ArrayList<Location> shortServedZonesList) {
        ...
        float transitShare = Float.parseFloat(MatsimExecuter.rb.getString("transit.modal.share"));
