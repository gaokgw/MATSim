...
import org.matsim.area.configMatsim.createDemandPt.MatsimGravityModel;
import org.matsim.area.configMatsim.createDemandPt.MatsimPopulationCreator;
import org.matsim.area.configMatsim.MatsimRunFromJava;
import org.matsim.area.configMatsim.createDemandPt.PtSyntheticTraveller;
import org.matsim.area.configMatsim.createDemandPt.ReadZonesServedByTransit;
import org.matsim.area.outputCreation.EuclideanDistanceCalculator;
import org.matsim.area.outputCreation.accessibilityCalculator.Accessibility;
import org.matsim.area.outputCreation.transitSkim.PtEventHandler;
import org.matsim.area.outputCreation.transitSkim.TransitSkimPostProcessing;
...
import org.matsim.area.outputCreation.TravelTimeMatrix;
import org.matsim.area.configMatsim.planCreation.ReadSyntheticPopulation;
...
public class MatsimExecuter {
    ...
    // this java should be run with a .properties file
